...
std::ostream& operator<<(std::ostream& out, const RowInterval& obj) {
  ...
  out << "RowInterval(";
  out << "start_row="; (obj.__isset.start_row ? (out << to_string(obj.start_row)) : (out << "<null>"));
...
std::ostream& operator<<(std::ostream& out, const CellInterval& obj) {
  ...
  out << "CellInterval(";
  out << "start_row="; (obj.__isset.start_row ? (out << to_string(obj.start_row)) : (out << "<null>"));
  out << ", " << "start_column="; (obj.__isset.start_column ? (out << to_string(obj.start_column)) : (out << "<null>"));
  out << ", " << "start_inclusive="; (obj.__isset.start_inclusive ? (out << to_string(obj.start_inclusive)) : (out << "<null>"));
  out << ", " << "end_row="; (obj.__isset.end_row ? (out << to_string(obj.end_row)) : (out << "<null>"));
  out << ", " << "end_column="; (obj.__isset.end_column ? (out << to_string(obj.end_column)) : (out << "<null>"));
  out << ", " << "end_inclusive="; (obj.__isset.end_inclusive ? (out << to_string(obj.end_inclusive)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ColumnPredicate& obj) {
  using apache::thrift::to_string;
  out << "ColumnPredicate(";
  out << "column_family="; (obj.__isset.column_family ? (out << to_string(obj.column_family)) : (out << "<null>"));
  out << ", " << "column_qualifier="; (obj.__isset.column_qualifier ? (out << to_string(obj.column_qualifier)) : (out << "<null>"));
...
std::ostream& operator<<(std::ostream& out, const ScanSpec& obj) {
  using apache::thrift::to_string;
  out << "ScanSpec(";
  out << "row_intervals="; (obj.__isset.row_intervals ? (out << to_string(obj.row_intervals)) : (out << "<null>"));
  out << ", " << "cell_intervals="; (obj.__isset.cell_intervals ? (out << to_string(obj.cell_intervals)) : (out << "<null>"));
  out << ", " << "return_deletes="; (obj.__isset.return_deletes ? (out << to_string(obj.return_deletes)) : (out << "<null>"));
  out << ", " << "versions="; (obj.__isset.versions ? (out << to_string(obj.versions)) : (out << "<null>"));
  out << ", " << "row_limit="; (obj.__isset.row_limit ? (out << to_string(obj.row_limit)) : (out << "<null>"));
  out << ", " << "start_time="; (obj.__isset.start_time ? (out << to_string(obj.start_time)) : (out << "<null>"));
  out << ", " << "end_time="; (obj.__isset.end_time ? (out << to_string(obj.end_time)) : (out << "<null>"));
  out << ", " << "columns="; (obj.__isset.columns ? (out << to_string(obj.columns)) : (out << "<null>"));
  out << ", " << "keys_only="; (obj.__isset.keys_only ? (out << to_string(obj.keys_only)) : (out << "<null>"));
  out << ", " << "cell_limit="; (obj.__isset.cell_limit ? (out << to_string(obj.cell_limit)) : (out << "<null>"));
  out << ", " << "cell_limit_per_family="; (obj.__isset.cell_limit_per_family ? (out << to_string(obj.cell_limit_per_family)) : (out << "<null>"));
  out << ", " << "row_regexp="; (obj.__isset.row_regexp ? (out << to_string(obj.row_regexp)) : (out << "<null>"));
  out << ", " << "value_regexp="; (obj.__isset.value_regexp ? (out << to_string(obj.value_regexp)) : (out << "<null>"));
  out << ", " << "scan_and_filter_rows="; (obj.__isset.scan_and_filter_rows ? (out << to_string(obj.scan_and_filter_rows)) : (out << "<null>"));
  out << ", " << "row_offset="; (obj.__isset.row_offset ? (out << to_string(obj.row_offset)) : (out << "<null>"));
  out << ", " << "cell_offset="; (obj.__isset.cell_offset ? (out << to_string(obj.cell_offset)) : (out << "<null>"));
  out << ", " << "column_predicates="; (obj.__isset.column_predicates ? (out << to_string(obj.column_predicates)) : (out << "<null>"));
  out << ", " << "do_not_cache="; (obj.__isset.do_not_cache ? (out << to_string(obj.do_not_cache)) : (out << "<null>"));
  out << ", " << "and_column_predicates="; (obj.__isset.and_column_predicates ? (out << to_string(obj.and_column_predicates)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Key& obj) {
  ...
  out << ", " << "column_family=" << to_string(obj.column_family);
  out << ", " << "column_qualifier=" << to_string(obj.column_qualifier);
  out << ", " << "timestamp="; (obj.__isset.timestamp ? (out << to_string(obj.timestamp)) : (out << "<null>"));
  out << ", " << "revision="; (obj.__isset.revision ? (out << to_string(obj.revision)) : (out << "<null>"));
...
std::ostream& operator<<(std::ostream& out, const MutateSpec& obj) {
  using apache::thrift::to_string;
  out << "MutateSpec(";
  out << "appname=" << to_string(obj.appname);
  out << ", " << "flush_interval=" << to_string(obj.flush_interval);
...
std::ostream& operator<<(std::ostream& out, const Result& obj) {
  using apache::thrift::to_string;
  out << "Result(";
  out << "is_empty=" << to_string(obj.is_empty);
  out << ", " << "id=" << to_string(obj.id);
  out << ", " << "is_scan=" << to_string(obj.is_scan);
  out << ", " << "is_error=" << to_string(obj.is_error);
  out << ", " << "error="; (obj.__isset.error ? (out << to_string(obj.error)) : (out << "<null>"));
  out << ", " << "error_msg="; (obj.__isset.error_msg ? (out << to_string(obj.error_msg)) : (out << "<null>"));
  out << ", " << "cells="; (obj.__isset.cells ? (out << to_string(obj.cells)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const NamespaceListing& obj) {
  ...
  out << ", " << "is_namespace=" << to_string(obj.is_namespace);
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const TableSplit& obj) {
  ...
  out << ", " << "ip_address="; (obj.__isset.ip_address ? (out << to_string(obj.ip_address)) : (out << "<null>"));
  out << ", " << "hostname="; (obj.__isset.hostname ? (out << to_string(obj.hostname)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ColumnFamilyOptions& obj) {
  ...
  out << "max_versions="; (obj.__isset.max_versions ? (out << to_string(obj.max_versions)) : (out << "<null>"));
  out << ", " << "ttl="; (obj.__isset.ttl ? (out << to_string(obj.ttl)) : (out << "<null>"));
  out << ", " << "time_order_desc="; (obj.__isset.time_order_desc ? (out << to_string(obj.time_order_desc)) : (out << "<null>"));
  out << ", " << "counter="; (obj.__isset.counter ? (out << to_string(obj.counter)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const ColumnFamilySpec& obj) {
  ...
  out << "name=" << to_string(obj.name);
  out << ", " << "access_group=" << to_string(obj.access_group);
  out << ", " << "deleted=" << to_string(obj.deleted);
  out << ", " << "generation="; (obj.__isset.generation ? (out << to_string(obj.generation)) : (out << "<null>"));
  out << ", " << "id="; (obj.__isset.id ? (out << to_string(obj.id)) : (out << "<null>"));
  out << ", " << "value_index=" << to_string(obj.value_index);
  out << ", " << "qualifier_index=" << to_string(obj.qualifier_index);
  out << ", " << "options="; (obj.__isset.options ? (out << to_string(obj.options)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const AccessGroupOptions& obj) {
  ...
  out << "replication="; (obj.__isset.replication ? (out << to_string(obj.replication)) : (out << "<null>"));
  out << ", " << "blocksize="; (obj.__isset.blocksize ? (out << to_string(obj.blocksize)) : (out << "<null>"));
  out << ", " << "compressor="; (obj.__isset.compressor ? (out << to_string(obj.compressor)) : (out << "<null>"));
  out << ", " << "bloom_filter="; (obj.__isset.bloom_filter ? (out << to_string(obj.bloom_filter)) : (out << "<null>"));
  out << ", " << "in_memory="; (obj.__isset.in_memory ? (out << to_string(obj.in_memory)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const AccessGroupSpec& obj) {
  ...
  out << ", " << "generation="; (obj.__isset.generation ? (out << to_string(obj.generation)) : (out << "<null>"));
  out << ", " << "options="; (obj.__isset.options ? (out << to_string(obj.options)) : (out << "<null>"));
  out << ", " << "defaults="; (obj.__isset.defaults ? (out << to_string(obj.defaults)) : (out << "<null>"));
  out << ")";
  return out;
}
...
std::ostream& operator<<(std::ostream& out, const Schema& obj) {
  using apache::thrift::to_string;
  out << "Schema(";
  out << "access_groups="; (obj.__isset.access_groups ? (out << to_string(obj.access_groups)) : (out << "<null>"));
  out << ", " << "column_families="; (obj.__isset.column_families ? (out << to_string(obj.column_families)) : (out << "<null>"));
  out << ", " << "generation="; (obj.__isset.generation ? (out << to_string(obj.generation)) : (out << "<null>"));
  out << ", " << "version="; (obj.__isset.version ? (out << to_string(obj.version)) : (out << "<null>"));
  out << ", " << "group_commit_interval="; (obj.__isset.group_commit_interval ? (out << to_string(obj.group_commit_interval)) : (out << "<null>"));
  out << ", " << "access_group_defaults="; (obj.__isset.access_group_defaults ? (out << to_string(obj.access_group_defaults)) : (out << "<null>"));
  out << ", " << "column_family_defaults="; (obj.__isset.column_family_defaults ? (out << to_string(obj.column_family_defaults)) : (out << "<null>"));
  out << ")";
  return out;
}
...
const char* Status::ascii_fingerprint = "3F5FC93B338687BC7235B1AB103F47B3";
const uint8_t Status::binary_fingerprint[16] = {0x3F,0x5F,0xC9,0x3B,0x33,0x86,0x87,0xBC,0x72,0x35,0xB1,0xAB,0x10,0x3F,0x47,0xB3};
