...
class HqlResult {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const HqlResult& obj);
};
...
class HqlResult2 {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const HqlResult2& obj);
};
...
class HqlResultAsArrays {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const HqlResultAsArrays& obj);
};
