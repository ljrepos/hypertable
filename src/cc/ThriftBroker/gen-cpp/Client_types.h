...
class RowInterval {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const RowInterval& obj);
};
...
class CellInterval {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const CellInterval& obj);
};
...
class ColumnPredicate {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ColumnPredicate& obj);
};
...
class ScanSpec {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ScanSpec& obj);
};
...
class MutateSpec {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const MutateSpec& obj);
};
...
class ResultAsArrays {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ResultAsArrays& obj);
};
...
class ResultSerialized {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ResultSerialized& obj);
};
...
class NamespaceListing {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const NamespaceListing& obj);
};
...
class TableSplit {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const TableSplit& obj);
};
...
class ColumnFamilyOptions {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ColumnFamilyOptions& obj);
};
...
class ColumnFamilySpec {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ColumnFamilySpec& obj);
};
...
class AccessGroupOptions {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const AccessGroupOptions& obj);
};
...
class AccessGroupSpec {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const AccessGroupSpec& obj);
};
...
class Status {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const Status& obj);
};
...
class ClientException : public ::apache::thrift::TException {
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const ClientException& obj);
};
