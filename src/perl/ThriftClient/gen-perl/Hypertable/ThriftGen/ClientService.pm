  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{schema} = new Hypertable::ThriftGen::Schema();
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^0$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{success} = new Hypertable::ThriftGen::Status();
        $xfer += $self->{success}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
...
sub send_refresh_table{
  ...
  $self->{output}->writeMessageBegin('refresh_table', TMessageType::CALL, $self->{seqid});
  my $args = new Hypertable::ThriftGen::ClientService_refresh_table_args();
  $args->{ns} = $ns;
  $args->{table_name} = $table_name;
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
...
sub recv_refresh_table{
  ...
  my $result = new Hypertable::ThriftGen::ClientService_refresh_table_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_status{
  ...
  $self->{output}->writeMessageBegin('status', TMessageType::CALL, $self->{seqid});
  my $args = new Hypertable::ThriftGen::ClientService_status_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_status{
  ...
  my $result = new Hypertable::ThriftGen::ClientService_status_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub send_shutdown{
  ...
  my $args = new Hypertable::ThriftGen::ClientService_shutdown_args();
  $args->write($self->{output});
  $self->{output}->writeMessageEnd();
  $self->{output}->getTransport()->flush();
}
...
sub recv_shutdown{
  ...
  my $result = new Hypertable::ThriftGen::ClientService_shutdown_result();
  $result->read($self->{input});
  $self->{input}->readMessageEnd();
...
sub process_refresh_table {
    ...
    $output->writeMessageBegin('refresh_table', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
...
sub process_status {
    ...
    $output->writeMessageBegin('status', TMessageType::REPLY, $seqid);
    $result->write($output);
    $output->writeMessageEnd();
    $output->getTransport()->flush();
}
