...
class table_create_args(object):
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'schema', (Schema, Schema.thrift_spec), None, ), # 3
  )
...
class future_get_result_args(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.ff)
    value = (value * 31) ^ hash(self.timeout_millis)
    return value
...
class scanner_open_args(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.ns)
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.scan_spec)
    return value
...
class shared_mutator_refresh_args(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.ns)
    value = (value * 31) ^ hash(self.table_name)
    value = (value * 31) ^ hash(self.mutate_spec)
    return value
...
class namespace_drop_args(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.ns)
    value = (value * 31) ^ hash(self.if_exists)
    return value
...
class rename_table_args(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.ns)
    value = (value * 31) ^ hash(self.name)
    value = (value * 31) ^ hash(self.new_name)
    return value
