...
class CellInterval(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.start_row)
    value = (value * 31) ^ hash(self.start_column)
    value = (value * 31) ^ hash(self.start_inclusive)
    value = (value * 31) ^ hash(self.end_row)
    value = (value * 31) ^ hash(self.end_column)
    value = (value * 31) ^ hash(self.end_inclusive)
    return value
...
class ScanSpec(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.row_intervals)
    value = (value * 31) ^ hash(self.cell_intervals)
    value = (value * 31) ^ hash(self.return_deletes)
    value = (value * 31) ^ hash(self.versions)
    value = (value * 31) ^ hash(self.row_limit)
    value = (value * 31) ^ hash(self.start_time)
    value = (value * 31) ^ hash(self.end_time)
    value = (value * 31) ^ hash(self.columns)
    value = (value * 31) ^ hash(self.keys_only)
    value = (value * 31) ^ hash(self.cell_limit)
    value = (value * 31) ^ hash(self.cell_limit_per_family)
    value = (value * 31) ^ hash(self.row_regexp)
    value = (value * 31) ^ hash(self.value_regexp)
    value = (value * 31) ^ hash(self.scan_and_filter_rows)
    value = (value * 31) ^ hash(self.row_offset)
    value = (value * 31) ^ hash(self.cell_offset)
    value = (value * 31) ^ hash(self.column_predicates)
    value = (value * 31) ^ hash(self.do_not_cache)
    value = (value * 31) ^ hash(self.and_column_predicates)
    return value
...
class MutateSpec(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.flush_interval)
...
class Result(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.is_empty)
    value = (value * 31) ^ hash(self.id)
    value = (value * 31) ^ hash(self.is_scan)
    value = (value * 31) ^ hash(self.is_error)
...
class NamespaceListing(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.is_namespace)
    return value
...
class ColumnFamilyOptions(object):
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.max_versions)
    value = (value * 31) ^ hash(self.ttl)
    value = (value * 31) ^ hash(self.time_order_desc)
...
class ColumnFamilySpec(object):
  ...
  thrift_spec = (
    ...
    (8, TType.STRUCT, 'options', (ColumnFamilyOptions, ColumnFamilyOptions.thrift_spec), None, ), # 8
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.name)
    value = (value * 31) ^ hash(self.access_group)
    value = (value * 31) ^ hash(self.deleted)
    value = (value * 31) ^ hash(self.generation)
    value = (value * 31) ^ hash(self.id)
    value = (value * 31) ^ hash(self.value_index)
    value = (value * 31) ^ hash(self.qualifier_index)
...
class AccessGroupOptions(object):
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.compressor)
    value = (value * 31) ^ hash(self.bloom_filter)
    value = (value * 31) ^ hash(self.in_memory)
    return value
...
class AccessGroupSpec(object):
  ...
  thrift_spec = (
    ...
    (3, TType.STRUCT, 'options', (AccessGroupOptions, AccessGroupOptions.thrift_spec), None, ), # 3
    (4, TType.STRUCT, 'defaults', (ColumnFamilyOptions, ColumnFamilyOptions.thrift_spec), None, ), # 4
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.generation)
    value = (value * 31) ^ hash(self.options)
    value = (value * 31) ^ hash(self.defaults)
    return value
...
class Schema(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'access_groups', (TType.STRING,None,TType.STRUCT,(AccessGroupSpec, AccessGroupSpec.thrift_spec)), None, ), # 1
    (2, TType.MAP, 'column_families', (TType.STRING,None,TType.STRUCT,(ColumnFamilySpec, ColumnFamilySpec.thrift_spec)), None, ), # 2
    (3, TType.I64, 'generation', None, None, ), # 3
    (4, TType.I32, 'version', None, None, ), # 4
    (5, TType.I32, 'group_commit_interval', None, None, ), # 5
    (6, TType.STRUCT, 'access_group_defaults', (AccessGroupOptions, AccessGroupOptions.thrift_spec), None, ), # 6
    (7, TType.STRUCT, 'column_family_defaults', (ColumnFamilyOptions, ColumnFamilyOptions.thrift_spec), None, ), # 7
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.access_groups)
    value = (value * 31) ^ hash(self.column_families)
    value = (value * 31) ^ hash(self.generation)
